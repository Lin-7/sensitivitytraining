...
def draw(lists, name_list):
    ...
    # color_list = ['black', '#F68080', '#F03131', '#DE1010', '#99C2FF', '#005FEE']
    # color_list = ['#F68080', '#F03131', '#DE1010', '#005FEE']
    # color_list = ['#F68080', '#F03131', '#DE1010', '#99C2FF', '#005FEE']
    color_list = ['#F68080', '#F03131', '#99C2FF', '#005FEE']
    # color_list = ['black', '#DE1010', '#005FEE']

    plt.figure()
    for i in range(len(lists)):
        plt.plot(lists[i], label=name_list[i][:-4], color=color_list[i])
    ...
    # plt.savefig('noise(Q5-L0.1-R7.65)-cWei-SGD(cosine)-lr0.01-epoch2&400-trobacc.png')
